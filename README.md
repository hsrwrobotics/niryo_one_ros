...
- loading a urdf model into gazebo is relatively easy, problem is getting it to listen to the right topics and laoding the right controllers
  ...
  - the `inertial` tags in this repo have been taken from the 'gazebo_simulations' branch of **Niryo Robotics**
...
- The urdf file also requires `libgazebo` plugin with the right parameters
